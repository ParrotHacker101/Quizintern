    ...
    public function loadMarks()
    {
        ...
        public function reviewQna(Request $request)
        {
            try {
                ...
                $attemptId = $request->attempt_id;
                 ...
                 $attemptData = ExamAnswer::where('attempt_id', $attemptId)->with(['question', 'answers'])->get();
        ...
        public function approvedQna(Request $request)
        {
            try {
                ...
                return response()->json(['success' => true,'msg'=>'successfully approved','data'=>$attemptData]);
